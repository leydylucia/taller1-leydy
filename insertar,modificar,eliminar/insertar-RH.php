<?php
/*el objetivo es de insertar datos de la tabla rh
...
$cod_rh = '6';
$des_rh = 'B-';
$sql= "INSERT INTO rh "// "select cod_rh,desc_rh,cod_ciudad from  rh,ciudad where rh.cod_ciudad=ciudad.cod_ciudad"
       ."(cod_rh,des_rh) "//"select cod_rh,desc_rh from  rh"
...
<body bgcolor=><center>
  <table bgcolor=#ccffcc border="3" width="80%" ><!--color verde claro-->
	...
	echo "Muy bien has insertado LOS DATOS
