<?php
/*el objetivo es de listar datos de la tabla rh
...
<meta charset="iso-8859-1">
  ...
  <body>
   ...
   <div id="baseglobal"><!--parte del css-->
     <header id="Encabezados">
         <th><img src="objetos/RH.gif"> </th><!--es el titulo tablas RH-->
    </header> 
  ...
  <body>
    ...
    <table bgcolor=#ccffcc border="3" width="80%" ><!--color verde claro-->
	 ...
	 <tr>
       <th>cod_rh</th><!--nombre que se le otorga en la tabla se aplica a la cantidad que necesites-->
         <th>des_rh</th>
...
<?php foreach($arrData as $row): ?><!--foreach hace que se repita la informacion en la bd-->
   <tr>
    <td><?php echo $row['cod_rh']?></td><!--@var $row me trae la informacion que esta en la consulta se aplica a todas las columnas de la tabla -->
