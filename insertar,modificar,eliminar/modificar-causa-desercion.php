<?php
/*el objetivo es modificar datos de la tabla causa_desercion
...
$sql= "update causa_desercion set des_causa='por que no supo' where cod_causa=6";
?>
