<?php
/*el objetivo es de modificar datos de la tabla centro
...
$sql="update centro set desc_centro='manipulacion de alimento',tel='248259',dir='palmira' where cod_centro=6" ;
